...
public class MergeSortBasicInsertion implements DivideAndConquerable<List<Integer>> {
  ...
  public List<? extends DivideAndConquerable<List<Integer>>> decompose() { {
    ...
    newList.add(new MergeSortBasicInsertion(listToSort.subList(0, firstHalf),this.isToSmallForMergeSort));
    newList.add(new MergeSortBasicInsertion(listToSort.subList(firstHalf, secondHalf),this.isToSmallForMergeSort));
    return  newList;
  }
